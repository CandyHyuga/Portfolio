  ...
  switch (activeModal.value) {
    ...
    case "instagram":
      return {
        ...
        fullUrl: "https://drive.google.com/file/d/17bIrC-6F02YuUZPpcyyM6tKslNVf9TMH/view?usp=sharing",
    ...
    case "discord":
      return {
        ...
        accountLabel: locale.value === "vi" ? "Tài khoản:" : "Account:",
        image: discordQrImg,
        fullUrl: "https://drive.google.com/file/d/1M82mFfOr5J0oeJPvcr31MYU7scJxZMES/view?usp=sharing",
        actionText: locale.value === "vi" ? "Xem ảnh gốc ↗" : "View Full Image ↗",
        directLink: null,
        phone: null,
      };
    case "zalo":
      return {
        ...
        image: zaloQrImg,
        fullUrl: "https://drive.google.com/file/d/1X_WhTjZ-mdSsLxCjV7ZidqXPNkqI7630/view?usp=sharing",
    ...
    case "facebook":
      return {
        ...
        accountLabel: locale.value === "vi" ? "Tài khoản:" : "Account:",
        image: facebookQrImg,
        fullUrl: "https://drive.google.com/file/d/1JTFqwkoW9jnRHVdxffUDfGWbg0d3q0Xw/view?usp=sharing",
        actionText: locale.value === "vi" ? "Xem ảnh gốc ↗" : "View Full Image ↗",
        directLink: null,
        phone: null,
      };
